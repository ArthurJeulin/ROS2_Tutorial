...
: ${AMENT_CURRENT_PREFIX:="/ssd/workspaces/learn_ros2/install/my_cpp_pck"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_cpp_pck/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_cpp_pck/environment/path.sh"
